<template>
    <section
        class="flex flex-col max-md:gap-20 md:flex-row pb-4 items-center justify-between mt-20 px-4 md:px-16 lg:px-24 xl:px-32">
        <div class="flex flex-col items-center md:items-start">
            ...
            <div class="flex items-center gap-4 mt-8 text-sm">
                ...
                <button
                    class="flex items-center gap-2 border border-slate-300 active:scale-95 hover:bg-white/10 transition text-slate-300 rounded-md px-6 h-11">
        ...
        <div class="relative flex flex-col my-24 bg-white shadow-sm border border-slate-200 rounded-lg w-96">
  <div class="p-4">
